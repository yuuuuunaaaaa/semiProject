...
<body>
	<form method="post" name="productinsert" id="addFrm" action="ProductInsert.post" enctype="multipart/form-data">
	<table>
		<tr>
			<td>상품명: </td>
			<td>
		...
		<tr>
			...
			<td>
				<select name="type">
					<option value="sticker" id="type">스티커</option>
					<option value="griptock" id="type">그립톡</option>
					<option value="case" id="type">케이스</option>
					<option value="etc" id="type">기타</option>
				</select>
			</td>
		</tr>
		<tr>
		...
		<input type="button"  onclick="proAdd();" value="상품 등록">
	</form>
</body>
</html>